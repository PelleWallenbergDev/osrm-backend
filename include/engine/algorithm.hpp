...
template <typename AlgorithmT>
struct HasTemporalAsymmetricOptimizedDirectShortestPathSearch final : std::false_type
{
};
template <typename AlgorithmT>
...
template <>
struct HasTemporalAsymmetricOptimizedDirectShortestPathSearch<mld::Algorithm> final
    : std::true_type
{
};
template <>
